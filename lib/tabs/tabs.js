...
var Tabs = React.createClass({
  ...
  render: function render() {
    ...
    var tabBarContainerStyle = _props.tabBarContainerStyle;

    var other = _objectWithoutProperties(_props, ['children', 'contentContainerStyle', 'initialSelectedIndex', 'inkBarStyle', 'style', 'tabWidth', 'tabItemContainerStyle', 'tabBarContainerStyle']);
    ...
    var tabBarContainerWidth = inkBarContainerWidth;
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { style: this.mergeAndPrefix({ paddingTop: 50 }, contentContainerStyle) },
        tabContent
      )
    );
  },
